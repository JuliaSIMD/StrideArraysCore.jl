...
@testset "StrideArraysCore.jl" begin
  ...
  @testset "StrideArrays Basic" begin
    ...
    GC.@preserve A begin
      ...
      @test Base.stride(Cslice,3) == Base.stride(C,3) == StrideArraysCore.stride(Cslice,3) == StrideArraysCore.stride(Cslice,static(3)) == StrideArraysCore.stride(C,3) == StrideArraysCore.stride(C,static(3))
      ...
      @test @inferred(size(view(C, StaticInt(1):StaticInt(8), :), StaticInt(1))) ===
            StaticInt(8)
